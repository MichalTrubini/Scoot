<template>
  ...
  >
    ...
    <div class="flex gap-4 justify-center md:mt-10 lg:m-0">
      <img
        :src="appleStore"
        alt="appleStore"
        class="inline-block w-[114px] h-10"
      />
      <img
        :src="googlePlay"
        alt="googlePlay"
        class="inline-block w-[130px] h-10"
      />
    </div>
  </div>
</template>
...
<style scoped>
.footerTop {
  background-image: url("../../assets/footerCircles.svg");
